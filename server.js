...
const youtube = new YouTube("AIzaSyDX_EDqoR8KVATRodMFdPgK8Gt7_KgwNrE"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyDX_EDqoR8KVATRodMFdPgK8Gt7_KgwNrE"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@1071363396202672140>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content.split(" ")[0] === prefix + "رابط") {
    ...
    const Embed11 = new Discord.RichEmbed().setColor("RANDOM")
      .setDescription(`** مدة الرابط : 30 يوم 
